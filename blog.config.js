...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://chinese-candy.com', // 网站地址
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-JLVBK83H4T', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
