...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://weekly.1q43.blog', // 网站地址
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-97EWYV4G81', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'hx4mv6ewgp', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || 'https://i0.wp.com/newsletter.1q43.blog/wp-content/uploads/2024/12/logo.png?resize=150%2C150&ssl=1', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
