...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '50eca795c95682d8966081e60cc8fce7',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '红流 AKASHIO', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个面向自己写作的自媒体，曾用名：赤潮AKAKSHIO', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://feed.akashio.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '赤潮,赤潮 AKASHIO, 红流 AKASHIO,评论尸,天使不投资人', // 网站关键词 英文逗号隔开
